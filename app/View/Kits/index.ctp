...
<div class="kits index">
	<h4 style="color:#00CED1;"><?php echo __('Kits'); ?></h4>
	...
	<tr>
            ...
            <th><?php echo $this->Paginator->sort('Kit Status'); ?></th>
	...
	<tr>
		<td><?php echo ($kit['Type']['code'] . '-' . $kit['Article']['type_number']); ?>&nbsp;</td>
		<td><?php echo ($kit['Article']['name']); ?>&nbsp;</td>
		<td><?php echo ($kit['Kit']['pid']); ?>&nbsp;</td>
        <td><?php echo ($kit['Kit']['hs_number']); ?>&nbsp;</td>
        <td><?php echo ($kit['Kit']['tax_group']) . '%'; ?>&nbsp;</td>
        <td><?php echo ($kit['Kit']['product_eccn']); ?>&nbsp;</td>
        <td><?php echo ($kit['Kit']['release_date']); ?>&nbsp;</td>
        <td><?php 
            if($kit['Kit']['for_distributors'] == null){
					echo "<i style='color:red;'> Ne </i>";
				}else{
					echo "<i style = 'color:green;'> Da </i>";
			}; ?>&nbsp;</td>
        <td><?php echo ($kit['Kit']['kit_status']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul class="menu vertical">
		...
		<li class="current"><?php echo $this->Html->link(__('Kits'), array('controller' => 'kits', 'action' => 'index')); ?> </li>
