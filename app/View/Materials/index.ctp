...
<div class="materials index">
	<h4 style="color:#00CED1;"><?php echo __('Materials'); ?></h4>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Material Status'); ?></th>
	...
	<tr>
		<td><?php echo ($material['Type']['code'] . '-' . $material['Article']['type_number']); ?>&nbsp;</td>
		<td><?php echo ($material['Article']['name']); ?>&nbsp;</td>
		<td><?php echo ($material['Material']['material_status']); ?>&nbsp;</td>
		<td><?php

			  if($material['Material']['service_production'] == null){
		...
		?>&nbsp;</td>
		<td><?php echo ($material['Material']['recommended_rating']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul class="menu vertical">
		...
		<li class="current"><?php echo $this->Html->link(__('Materials'), array('controller' => 'materials', 'action' => 'index')); ?> </li>
