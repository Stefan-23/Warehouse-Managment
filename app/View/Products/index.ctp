...
<div class="products index">
	<h4 style="color:#00CED1;"><?php echo __('Products'); ?></h4>
	...
	<tr>
            ...
            <th><?php echo $this->Paginator->sort('Product ECCN'); ?></th>
	...
	<tr>
		<td><?php echo ($product['Type']['code'] . '-' . $product['Article']['type_number']); ?>&nbsp;</td>
		<td><?php echo ($product['Article']['name']); ?>&nbsp;</td>
		<td><?php echo ($product['Product']['pid']); ?>&nbsp;</td>
        <td><?php echo ($product['Product']['hs_number']); ?>&nbsp;</td>
        <td><?php echo ($product['Product']['tax_group']) . '%'; ?>&nbsp;</td>
        <td><?php echo ($product['Product']['product_eccn']); ?>&nbsp;</td>
        <td><?php echo ($product['Product']['release_date']); ?>&nbsp;</td>
		<td><?php 
		
			if($product['Product']['for_distributors'] == null){
		...
		<td><?php
			  ...
			  if($product['Product']['service_production'] == null){
					echo "<i style='color:red;'> Ne </i>";
			}else{
					echo "<i style = 'color:green;'> Da </i>";
			}
...
<div class="actions">
	...
	<li><?php echo $this->Html->link(__('New Product'), array('action' => 'save')); ?></li>
		...
		<li class="current"><?php echo $this->Html->link(__('Products'), array('controller' => 'products', 'action' => 'index')); ?> </li>
